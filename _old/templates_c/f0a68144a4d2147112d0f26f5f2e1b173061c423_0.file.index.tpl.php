<?php
/* Smarty version 3.1.30, created on 2017-05-23 07:16:35
  from "/home/ubuntu/workspace/template/index.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5923e1d385fd43_64990860',
...
function content_5923e1d385fd43_64990860 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
...
>
    <?php echo '<script'; ?>
 src="js/dataTables.rowsGroup.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
...
>
    <?php echo $_smarty_tpl->tpl_vars['piwikScript']->value;?>
...
<span class="caret"></span></a>
                                            <ul class="dropdown-menu">
                                                <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['methodes']->value['minion'], 'method');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['method']->value) {
?> <li><a id='<?php echo $_smarty_tpl->tpl_vars['method']->value['id'];?>
' class='minions_methode'><?php echo $_smarty_tpl->tpl_vars['method']->value['name'];?>
</a></li> <?php
}
}
...
?>
                                        ...
                                        <li class="dropdown">
                                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
          <?php echo $_smarty_tpl->tpl_vars['dropdown_mounts']->value;?>
<span class="caret"></span></a>
                                            <ul class="dropdown-menu">
                                                <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['methodes']->value['mount'], 'method');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['method']->value) {
?> <li><a id='<?php echo $_smarty_tpl->tpl_vars['method']->value['id'];?>
' class='mounts_methode'><?php echo $_smarty_tpl->tpl_vars['method']->value['name'];?>
</a></li> <?php
}
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl);
...
<span class="caret"></span></a>
                                            <ul class="dropdown-menu">
                                                <li><a id='all' class='ranking_dropdown'><?php echo $_smarty_tpl->tpl_vars['all']->value;?>
</a>
                                                </li>
                                                <li><a id='minions' class='ranking_dropdown'><?php echo $_smarty_tpl->tpl_vars['minions']->value;?>
</a>
                                                </li>
                                                <li><a id='mounts' class='ranking_dropdown'><?php echo $_smarty_tpl->tpl_vars['mounts']->value;?>
</a>
                                                <li role="separator" class="divider"></li>
                                                <li class="dropdown-header"><?php echo $_smarty_tpl->tpl_vars['rarity']->value;?>
</li>
                                                </li>
                                                <li><a id='rarity_all' class='ranking_dropdown'><?php echo $_smarty_tpl->tpl_vars['all']->value;?>
</a>
                                                <li><a id='rarity_minions' class='ranking_dropdown'><?php echo $_smarty_tpl->tpl_vars['minions']->value;?>
</a>
                                                <li><a id='rarity_mounts' class='ranking_dropdown'><?php echo $_smarty_tpl->tpl_vars['mounts']->value;?>
</a>
                                                </li>
                                            </ul>
                                        </li>
                                    ...
                                    <form id="char_search" class="navbar-form navbar-left form-inline" action="charakter.php" method="get">
                                        <div class="form-group">
                                            <input type="text" class="form-control" placeholder="<?php echo $_smarty_tpl->tpl_vars['char_search_placeholder']->value;?>
" name="name">
                                    ...
                                    <form class="navbar-form navbar-right form-inline">
                                        <select class="form-control" id="lang">
                                            <option value="en" <?php echo $_smarty_tpl->tpl_vars['en_select']->value;?>
>English</option>
                                            <option value="fr" <?php echo $_smarty_tpl->tpl_vars['fr_select']->value;?>
>Français</option>
                                            <option value="de" <?php echo $_smarty_tpl->tpl_vars['de_select']->value;?>
>Deutsch</option>
                                            <option value="ja" <?php echo $_smarty_tpl->tpl_vars['ja_select']->value;?>
>日本語</option>
                                        </select>
                                    </form>
                                    <form class="navbar-form navbar-right form-inline">
                                        <button type="button" class="btn btn-primary" id="user" style="display: none;">
                                            <span class="glyphicon glyphicon-user" aria-hidden="true" /> <?php echo $_smarty_tpl->tpl_vars['my_char']->value;?>
                        ...
                        <div class="rounded_row">
                            <div id="content" style="padding:20px">
                                <?php if ($_smarty_tpl->tpl_vars['startpage']->value) {?>
                        ...
                        <footer style="background-color:rgba(255, 255, 255, 0.5);" class="rounded">
                            ...
                            <p class="text-center">
                                <a data-toggle="modal" data-target="#updateDB">Update</a> - <a data-toggle="modal" data-target="#request">Request Change</a> - Today updated characters: <?php echo $_smarty_tpl->tpl_vars['count_today']->value;?>
