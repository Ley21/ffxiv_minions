<center>
  ...
  <ul class="nav nav-pills" role="tablist">
    <li role="presentation" class="active"><a href="#character" aria-controls="home" role="tab" data-toggle="tab">{$title.character}</a></li>
    <li role="presentation" class="disabled" data-toggle="tooltip" title="Work in progress!"><a role="tab" >Triple Triad</a></li>
    <li role="presentation" class="disabled" data-toggle="tooltip" title="Work in progress!"><a role="tab" >Orchestion</a></li>
     <li role="presentation" class="disabled" data-toggle="tooltip" title="Work in progress!"><a role="tab" >Relic Weapons</a></li>
  </ul>
...
<!-- Tab panes -->
  <div class="tab-content">
    ...
    <div role="tabpanel" class="tab-pane" id="tripleTriad"></div>
    <div role="tabpanel" class="tab-pane" id="orchestion"></div>
    <div role="tabpanel" class="tab-pane" id="relic"></div>
  </div>
